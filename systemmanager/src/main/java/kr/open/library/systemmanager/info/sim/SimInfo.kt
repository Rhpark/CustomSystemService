package kr.open.library.systemmanager.info.sim
 ...
 * ```
 */
public class SimInfo(context: Context) : BaseSystemService(
    context,
    ...
    public val subscriptionManager: SubscriptionManager by lazy { 
        context.getSubscriptionManager() 
    }
    ...
    public fun getSubId(simSlotIndex: Int): Int? = try {
        ...
        Logx.e("SimInfo: Cannot read uSim Chip, subId = -1, e = $e")
        null
    }
     ...
     * Get all active subscription information list (Result pattern)
     */
    @RequiresPermission(READ_PHONE_STATE)
