package kr.open.library.systemmanager.info.network.connectivity.callback
...
import kr.open.library.systemmanager.info.network.telephony.data.state.TelephonyNetworkDetailType
import kr.open.library.systemmanager.info.network.telephony.data.state.TelephonyNetworkState
import kr.open.library.systemmanager.info.network.telephony.data.state.TelephonyNetworkType
